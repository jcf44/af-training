#!/bin/bash
# DeepStream TensorRT Engine Builder for x86/Cloud
# Builds FP16 optimized engines for server deployment
...
echo "=========================================="
echo "TensorRT Engine Builder - x86/Cloud"
echo "=========================================="
...
for onnx_file in "$MODELS_DIR"/*.onnx; do
    ...
    engine_file="$ENGINES_DIR/${base_name}_fp16.engine"
    ...
    echo ""
    echo "Building FP16 engine for: $base_name"
    echo "----------------------------------------"
